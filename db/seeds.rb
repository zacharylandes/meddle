...
class Seed
  ...
  def run
    ...
    shots = ['https://s3.amazonaws.com/pytdating/p2.jpeg','https://s3.amazonaws.com/pytdating/p3.jpeg','https://s3.amazonaws.com/pytdating/p4.jpeg','https://s3.amazonaws.com/pytdating/p1.jpeg','https://s3.amazonaws.com/pytdating/p7.jpeg','https://s3.amazonaws.com/pytdating/p11.jpeg','https://s3.amazonaws.com/pytdating/12.jpeg','https://s3.amazonaws.com/pytdating/13.jpeg']
    ...
    user_7 = User.create!( id: 700, provider: "google_oauth2", uid: "123359", auth_name: "Mr.Match", oauth_token: "tokenhere", oauth_expires_at: "2018-04-04 20:19:18", created_at: "2018-04-04 19:19:19", updated_at: "2018-04-04 19:19:19", f_name: "Stack", l_name:"Steiner", email: "email7@email.com", remote_image_url: shots[1] )
